...
from pdfm_domain_only_v2 import PromptDeepFactorizationMachineModel_domain_only
from pdfm_mlp_only_v2 import PromptDeepFactorizationMachineModel_mlp_only

from torchfm.model.afn import AdaptiveFactorizationNetwork
from xdfm import ExtremeDeepFactorizationMachineModel

#from prompt_xdfm_autodis import prompt_ExtremeDeepFactorizationMachineModel_autodis
#from model.prompt_xdfm_autodis_v2 import prompt_ExtremeDeepFactorizationMachineModel_autodis
#from prompt_wd_autodis import prompt_WideAndDeepModel_autodis

#from model.pdfm_user_autodis_v2 import PromptDeepFactorizationMachineModel_user_autodis
...
def main(dataset_name,
    ...
    domain_id = np.full((dataset.items.shape[0],1),1)
    ...
    #print(dataset.items[test_dataset.indices])
    ...
    if mode=='test':
        #model = torch.load(f'{save_dir}/{model_name}_douban_train_{job}.pt')
    ...
    for name, param in model.named_parameters():
        ...
        if name == 'embedding_prompt.embedding.weight':
            a=param
    print(param_count)
    #print(model.embedding_prompt.embedding)
