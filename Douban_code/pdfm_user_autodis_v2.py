...
from layer import FactorizationMachine, FeaturesEmbedding, FeaturesEmbedding2, FeaturesLinear, MultiLayerPerceptron, MultiLayerPerceptron_normal, autodis


class PromptDeepFactorizationMachineModel_user_autodis(torch.nn.Module):
    """
    ...
    def __init__(self, field_dims, embed_dim, mlp_dims, dropout, domain_id, number, max_val, temperature):
        super().__init__()
        ...
        self.autodis_model = autodis(embed_dim, (32, 32), dropout, number, temperature)
    ...
    def forward(self, x):
        ...
        user_prompt = self.autodis_model(embed_x[:,0,:self.embed_dim])
